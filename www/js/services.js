...
.factory('Painters', function () {
	...
	var ru = [{
		...
		"desc": {
			...
			"loginRegisterDesc": "Регистрация позволит вам учавствовать в турнире, а так же сохранять статистику своих игр",
			...
			"loginSuccessEmailText": "__username__, спасибо Вам за регистрацию в Art Challenge!<br>Теперь вы сможете учавствовать в турнире и отслеживать статистику своих ответов в игре.<br>По любым вопросам пишите нам на info@artchallenge.ru.<br>Если хотите следить за новостями из мира культуры, то подписывайте на нас в социальных сетях:<br>ВКонтакте: http://vk.com/art.challenge<br>Facebook: http://facebook.com/artchallenge.ru<br><br>Искренне Ваши, команда Art Challenge<br>Рубен и Анна.",
	...
	var en = [{
		...
		"desc": {
			...
			"loginSuccessEmailText": "__username__, thank you for registering Art Challenge!<br>Now you can take part in the tournament and monitor the statistics of your games.<br>For any questions please contact us at info@artchallenge.ru.<br>If you want to follow the news from the world of culture, then follow us in social networks:<br>VKontakte: http://vk.com/art.challenge<br>Facebook: http://facebook.com/artchallenge.ru<br><br>Sincerely, Art Challenge Team<br>Ruben and Anna.",
