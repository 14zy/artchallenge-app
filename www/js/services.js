...
.factory('Painters', function () {
	...
	var ru = [{
		...
		"desc": {
			...
			"statsNoDataText": "Слишком мало ответов в коллекции <b>__setName__</b>, поиграйте в нее несколько дней и тут появится график ваших ответов.",
			...
			"loginRegisterDesc": "Регистрация позволит вам учавствовать в дуэлях и турнире, а так же сохранять статистику своих игр",
			...
			"loginSuccessEmailText": "__username__, спасибо Вам за регистрацию в Art Challenge!<br>Теперь вы сможете учавствовать в турнире, дуэлях и отслеживать статистику своих ответов в игре.<br>По любым вопросам пишите нам на info@artchallenge.ru.<br>Если хотите следить за новостями из мира культуры, то подписывайте на нас в социальных сетях:<br>ВКонтакте: http://vk.com/art.challenge<br>Facebook: http://facebook.com/artchallenge.ru<br><br>Искренне Ваши, команда Art Challenge<br>Рубен и Анна.",
	...
	var en = [{
		...
		"desc": {
			...
			"loginRegisterDesc": "Registration will allow you to participate in duels and tournaments, and keep the statistics of your games",
			...
			"loginBtnLogin": "Login",
			"loginMessageSuccessRegister": "You have successfully looged in!",
			"loginMessageSuccessLogin": "You have successfully logged!",
			"loginSuccessEmailText": "__username__, thank you for registering Art Challenge!<br>Now you can take part in the tournament, duels and monitor the statistics of your games.<br>For any questions please contact us at info@artchallenge.ru.<br>If you want to follow the news from the world of culture, then follow us in social networks:<br>VKontakte: http://vk.com/art.challenge<br>Facebook: http://facebook.com/artchallenge.ru<br><br>Sincerely, Art Challenge Team<br>Ruben and Anna.",
	...
	var de = [{
		...
		"desc": {
			"what": "Was hier alles zu tun ist?",
			"what-desc": "Hier kann man Spaẞ bekommen und seine Kenntnisse in Bildkunst prüfen",
			"how": "Worin besteht die Aufgabe dieses Spieles?",
			"how-desc": "Man muss die Gemälde und die Kunstmaler erraten.<br>Gewinnen nur die Personen, die die zehn Gemälde nacheinander erraten können.",
			"what-good": "Was bringt es?",
			"what-good-desc": "Spielen Sie in Ihrer Freizeit und demnachst können Sie ohne Muhe Claude Monet von Edouard Manet und bestimmt von Alfred Sisley auf dem ersten Blick unterscheiden :)",
			"how-help": "Wie kann ich Ihnen helfen?",
			"how-help-desc": "Wenn Ihnen diese Webseite gefallen hat, seien Sie so nett, erzählen Sie davon Ihren Freunden.",
		...
		"message": {
			"right": "Richtig!",
			"right-desc": "Das Gemalde __count__ ist erraten",
		...
		"badPhrases": {
			...
			"7": "Nein, nein und noch einmal nein!",
	...
	var es = [{
		...
		"message": {
			"right": "¡Has acertado!",
			"right-desc": "El cuadro __count__ está acabado",
			"wrong": "‘Incorrecto!",
			"wrong-desc": "Es",
			"years": "Años",
	...
	var fr = [{
		...
		"shares": {
			...
			"description": "Essayez de deviner 10 artistes de suite et battre vos amis!",
			"caption": "Art Challenge - Game on Knowledge of Popular Painters"
		},
		"footer": {
	...
	return {
		...
		basic: function () {
			var paintersSet = [];
			var paintersSetIDs = [1, 4, 7, 9, 14, 15, 17, 19, 21, 22, 24, 26, 27, 28, 29, 30, 32, 33, 34, 35, 36, 39, 40, 41, 42, 43, 45, 46, 49, 50, 53, 54, 55, 57, 58, 61, 62, 63, 69, 73, 75, 77, 79, 80, 82, 83, 94, 95, 112, 118];
